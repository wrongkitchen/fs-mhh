        ...
        <div id="mainContent" class="leftrightContent">
            <div class="container">
                ...
                <div class="pull-left leftContent">
                    <div class="buttonContainer">
                        ...
                        <div class="button sub active">
                            Pacific House
                            <a href="office-pacific-overview.php"><div class="subButton active">-  Overview</div></a>
                ...
                <div class="pull-right rightContent">
                    <div class="title">Pacific House - Overview</div>
                    <table width="45%" class="pull-left">
                        <tr>
                            <td>
                                <div class="subTitle">Excepteur sint occaecat Duis aute irure In voluptate velit esse cillum dolore eu fugiat pariatur. Lorem ipsum dolor sit amet, consectetur adipisicing eliT.</div>
                                <div class="desc">Pacific House is right in the heart of core Central with the most prestigious address of Queen’s Road Central and is just opposite to The Landmark Mandarin Oriental. It’s an ideal home to financial institutions, beauty centers, salon, clinic, private club, jewelry as well as any kind of office and retail tenants.</div><br /><br />
                            </td>
                        </tr>
                    </table>
                    <table width="45%" class="pull-right">
                        <tr>
                            <td>
                                <div class="galleryContainer">
                                    <div class="image"><img src="img/office/pacific-house/office-pacific-overview00.jpg" alt=""></div>
                                    <div class="thumbContainer">
                                        <div class="thumb"><img src="img/office/pacific-house/office-pacific-overview01.jpg" alt=""></div>
                                        <div class="thumb"><img src="img/office/pacific-house/office-pacific-overview02.jpg" alt=""></div>
                                        <div class="thumb end"><img src="img/office/pacific-house/office-pacific-overview03.jpg" alt=""></div>
