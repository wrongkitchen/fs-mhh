        ...
        <div id="mainContent" class="leftrightContent retail">
            ...
            <div class="container">
                    ...
                    <div class="buttonContainer">
                        <div class="button sub active end">
                            ...
                            <a href="retail-happening.php">
                                <div class="subButton active">- Happenings</div>
                            </a>
                ...
                <div class="pull-right rightContent">
                    <div class="subTitle">Happenings</div><br />
                    <div class="lineBlock"></div><br />
                    <div class="happening">
                        <div class="happen block">
                            <table>
                                <tr>
                                    <td>
                                        <div class="happenDate">16/12/2012 - 26/12/2012</div>
                                        <div class="happenTitle">Duis autem ipsum dolor sit amet</div>
                                        <div class="happenDesc">Duis autem  ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</div>
                                    </td>
                                    <td width="20"></td>
                                    <td width="250"><img src="img/retail/retail-happening00.jpg" alt=""></td>
                                </tr>
                            </table>
                        </div>
                        <div class="happen block even">
                            <table>
                                <tr>
                                    <td>
                                        <div class="happenDate">16/12/2012 - 26/12/2012</div>
                                    ...
                                    <td width="20"></td>
                                    <td width="250"><img src="img/retail/retail-happening01.jpg" alt=""></td>
                                </tr>
                            </table>
                        </div>
                        <div class="happen block">
                            <table>
                                <tr>
                                    ...
                                    <td width="20"></td>
                                    <td width="250"><img src="img/retail/retail-happening02.jpg" alt=""></td>
                                </tr>
                            </table>
                        </div>
                        <div class="happen block even">
                            <table>
                                <tr>
                                    ...
                                    <td width="20"></td>
                                    <td width="250"><img src="img/retail/retail-happening03.jpg" alt=""></td>
                                </tr>
                            </table>
                        </div>
                    </div>
