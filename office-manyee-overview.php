        ...
        <div id="mainContent" class="leftrightContent">
            <div class="container">
                ...
                <div class="pull-left leftContent">
                    <div class="buttonContainer">
                        <div class="button sub active">
                            Man Yee Building
                            <a href="office-manyee-overview.php"><div class="subButton active">-  Overview</div></a>
                ...
                <div class="pull-right rightContent">
                    <div class="title">Man Yee Building - Overview</div>
                    <table width="45%" class="pull-left">
                        <tr>
                            <td>
                                <div class="subTitle">Man Yee Building, the Group’s flagship property, offers over 290,000 sq. ft. of office space, a 4-leval shopping arcade and 3 floors of basement car parks.</div>
                                <div class="desc">The building’s layout, services and facilities are second to none and are designed for the specific needs of banks and financial services tenants.</div><br /><br />
                            </td>
                        </tr>
                    </table>
                        ...
                        <tr>
                            <td>
                                <div class="galleryContainer">
                                    <div class="image"><img src="img/office/office-overview-slide00.jpg" alt=""></div>
                                    <div class="thumbContainer">
                                        <div class="thumb"><img src="img/office/office-overview-slideThumb00.jpg" alt=""></div>
                                        <div class="thumb"><img src="img/office/office-overview-slideThumb01.jpg" alt=""></div>
                                        <div class="thumb end"><img src="img/office/office-overview-slideThumb02.jpg" alt=""></div>
